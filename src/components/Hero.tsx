...
function Hero() {
  return (
    <div>
   <section className="text-center px-6 py-24 h-screen sm:px-12 sm:py-32 md:px-20  xl:py-40">
        {/* Notification Banner */}
        ...
        <div className="text-center">
          <h1 className="text-[2.2rem] leading-[3rem] lg:leading-relaxed font-bold tracking-wider bg-gradient-to-r from-[#87aeb5] to-[#f1f8fc] bg-clip-text text-transparent lg:text-[3.5rem]">
            Empowering Students with Seamless Management
          </h1>
          <p className="px-2 sm:px-12 md:px-28 text-sm tracking-widest leading-6 text-[#cde5e0]">
          ...
          <div className="mt-2 flex flex-col sm:flex-row items-center justify-center gap-y-2 sm:gap-x-6">
